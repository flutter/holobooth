...
void main() {
  ...
  testWidgets('facebook button dismissed when popped', (tester) async {
    await tester.pumpApp(buildSubject());
    await tester.tap(find.byType(ElevatedButton));
    await tester.pumpAndSettle();
    expect(find.byType(ElevatedButton), findsNothing);
    verify(() => shareBloc.add(const ShareTapped(shareUrl: ShareUrl.facebook)))
        .called(1);
  });

  testWidgets('facebook button opens link when sharing is successful',
      (tester) async {
